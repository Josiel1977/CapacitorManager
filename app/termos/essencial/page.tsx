export default function TermosEssencialPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold text-primary mb-6">Termos de Uso – Plano Essencial</h1>
      <div className="prose prose-sm">
        ...
        <p>Valor mensal de R$ 297,00 (duzentos e noventa e sete reais), cobrado automaticamente via Mercado Pago.</p>
