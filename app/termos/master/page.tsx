export default function TermosMasterPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold text-primary mb-6">Termos de Uso – Plano Master</h1>
      <div className="prose prose-sm">
        ...
        <p>Valor mensal de R$ 797,00 (setecentos e noventa e sete reais), cobrado automaticamente via Mercado Pago.</p>
