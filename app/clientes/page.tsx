      ...
      if (editingCliente) {
        const { error } = await supabase
          ...
          .update({
            ...
            contato_responsavel: formData.contato_responsavel || null,
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-8 flex justify-end gap-3">
                  ...
                  <button 
                    type="submit"
                    disabled={submitting}
                    className="flex items-center gap-2 rounded-lg bg-primary px-6 py-2 text-white transition-all hover:bg-primary/90 disabled:opacity-50"
                  >
                    {submitting ? (
                      <>
