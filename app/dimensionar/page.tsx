      ...
      if (precisaCapacitor) {
        ...
        motivo =
          ...
          (demandaPersonalizadaKw > 0
            ...
            : ` (Demanda registrada: ${demandaMaxRegistrada.toFixed(1)} kW | Estimada: ${(potenciaTotalTransformadores * fatorCarga * fpAtual).toFixed(1)} kW)`) +
          (margemSeguranca > 0
              ...
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs text-slate-500">
                    Multa informada (opcional)
                  </label>
                  <input
                    type="text"
                    placeholder="Ex: 1961.05"
                    value={currentFatura.multa_informada_str ?? ""}
                    onChange={(e) =>
                      setCurrentFatura({
                        ...currentFatura,
                        multa_informada_str: e.target.value,
                      })
                    }
                    className="w-full border rounded p-2 text-sm mt-1"
                  />
