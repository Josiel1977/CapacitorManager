...
// ============================================
// CONSTANTES (complete com seus preços)
// ============================================
...
const distribuirEstagios = (total: number, n: number) => {
  n = Math.min(8, Math.max(6, n));
  let stages = Array(n)
    .fill(0)
    .map((_, i) =>
      i === n - 1
        ? total - stages.reduce((a, b) => a + b, 0)
        : Math.round(total / n / 2.5) * 2.5,
    );
...
const distribuirKvarPorTrafo = (
  ...
  /* função completa igual ao original, omitida por brevidade, mas você deve colar a sua versão */ return [];
};
...
function DimensionarContent() {
  ...
  // ============================================
  // AUTENTICAÇÃO (CORRIGIDA - onAuthStateChange)
  // ============================================
  useEffect(() => {
    let isMounted = true;
    const {
  ...
  // CRUD Transformadores (igual ao original)
  ...
  // CRUD Faturas com campos string
  ...
  // ============================================
  // DIMENSIONAMENTO (EXATAMENTE O SEU CÓDIGO ORIGINAL)
  // ============================================
  ...
  // ============================================
  // RENDER (use o seu JSX, com o modal corrigido)
  // ============================================
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* Coluna esquerda: Transformadores, Faturas, Configurações */}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border">
            ...
            <details className="mb-4">
              ...
              <div className="mt-3 space-y-4 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                  <label className="text-xs text-slate-600">
                    Número de estágios automáticos (6 a 8)
                  </label>
                  <input
                    type="range"
                    min="6"
      ...
      {/* MODAL DE FATURA (com campos editáveis) */}
      <AnimatePresence>
        {showFaturaModal && (
